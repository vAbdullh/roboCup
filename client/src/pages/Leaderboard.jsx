                    ...
                    <div className="w-full overflow-x-auto overscroll-none md:px-5">
                        <table className="w-full text-sm text-left text-gray-500">
                            <thead className="text-xs text-gray-700 capitalize">
                                <tr className='bg-gray-50 border-b tracking-wide'>
                                    <th scope="col" className="px-6 py-4 font-medium w-5 sticky left-0 bg-gray-50 z-10">#</th>
                                    <th scope="col" className="px-6 py-4 font-medium sticky left-12 bg-gray-50 z-10">Team Name</th>
                                    <th scope="col" className="px-6 py-4 font-medium text-center text-green-500 ">Wins</th>
                                    <th scope="col" className="px-6 py-4 font-medium text-center text-red-500">Losses</th>
                                    <th scope="col" className="px-6 py-4 font-medium text-center text-orange-500">Draws</th>
                                    <th scope="col" className="px-6 py-4 font-medium text-center">Points</th>
                                </tr>
                            </thead>
                            <tbody>
                                {teams
                                    ...
                                    .map((team, index) => (
                                        <tr key={team.id} className={`border-b border-gray-200 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                            ...
                                            <th className="px-6 py-4 font-light text-gray-900 whitespace-nowrap capitalize sticky left-12 bg-white">
                                                {team.name}
                                            </th>

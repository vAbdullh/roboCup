...
const Rules = () => {
    const rulesData = {
        robotSpecifications: [
            ...
            "Each team is allowed one to two robots at most for the entire tournament. The substitution of robots during the competition within the team or with other teams is forbidden.",
        ...
        matchRules: [
            "Each match consists of two teams. Each team have one robot.",
            ...
            "The registered teams will be divided into groups of 4. Each team will play 3 matches and earn points: 3 points for a win, 1 point for a draw, and 0 points for a loss. Teams in each group will be ranked by points from first to fourth. The top two teams from each group will advance.",
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-[#263741]">
            <Header dark_text />
            <div className="container mx-auto px-4 flex flex-col gap-5 py-16">
                {/* Title Section */}
                <section>
                    <h1 className="text-5xl font-bold mb-4">RoboCup 2025 Rules</h1>
                    <p className="">Key requirements for RoboCup 2025 participants</p>
                </section>
